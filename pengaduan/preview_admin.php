    ...
    <div class="card shadow mb-4 w-50" data-aos="fade-up">
      ...
      <div class="collapse show" id="generate">
        <div class="card-body">
          ...
          <hr class="bg-primary">
          <h6 class="mb-3"><span class="text-success font-weight-bold">Laporan :</span> <?= $row['isi_laporan']; ?></h6>
          <h6><span class="text-success font-weight-bold">Tanggapan :</span> <?= $row['tanggapan']; ?></h6>
          <hr class="bg-primary">
          <div class="row">
            <div class="col-8 mt-2">
              <h6> <span class="text-success font-weight-bold">Di tanggapi dari :</span> <?= $row['nama_petugas']; ?></h6>
            </div>
            <div class="col-4">
              <div class="d-flex justify-content-end">
                <a href="dashboard_admin.php" class="btn btn-outline-success">Kembali</a>
              </div>
            </div>
          </div>
        </div>
