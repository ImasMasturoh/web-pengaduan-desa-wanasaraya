...
<div class="d-flex justify-content-center py-5">
  <div class="card w-25 shadow" data-aos="zoom-in">
    <div class="card-body border-bottom-success">
      <h5 class="text-success text-center">Registrasi</h5>
      <hr class="bg-success">
      <form action="" method="post">
        ...
        <div class="button">
          <button class="btn btn-success shadow-sm py-2 col-12" name="submit" style="border-radius: 25px;">Registrasi</button>
        </div>
      </form>
    </div>
  </div>
